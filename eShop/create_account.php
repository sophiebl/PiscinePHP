...
if (isset($_POST['submit']))
{
	if ($_POST['submit'] == "OK")
	{
		if(isset($_POST['firstname']) && isset($_POST['lastname']) && isset($_POST['email']) && $_POST['email'] != "" && isset($_POST['phone']) && isset($_POST['address']) && isset($_POST['postal_code']) && isset($_POST['city']) && isset($_POST['country']) && isset($_POST['passwd']) && ($_POST['passwd'] != ""))
		{
